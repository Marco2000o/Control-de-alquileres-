...
PreparedStatement ps;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 190, 80, -1));
        ...
        getContentPane().add(txtusuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 70, 120, -1));
        getContentPane().add(txtcontra, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 130, 120, -1));
    ...
    try {
        ...
        db_conexion.getConnection();
        if (db_conexion.Login(txtusuario.getText(), txtcontra.getText())== 1) {
            MP.setVisible(true);
    ...
    public static Clientes MP = new Clientes();
}
